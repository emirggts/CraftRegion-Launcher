...
class Settings {
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Başlatıcıyla birlikte verilen Java sürümünü kullanın';
        ...
        document.querySelector(".path-button").addEventListener("click", async() => {
            ...
            } else alert("Dosya adı java veya javaw olmalıdır");

        });

        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Başlatıcıyla birlikte verilen Java sürümünü kullanın';
            file.value = '';
